              ...
              <Grid container className={classes.leftContainer}>
                <Grid item md={6} sm={6} className={classes.iconsGrid}>
                  <Link
                    ...
                    href="https://github.com/BhavyaRohilla"
                    target="_blank"
                  ...
                  <Link
                    className={classes.socialItem}
                    href="https://www.linkedin.com/in/bhavyarohilla/"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                  ...
                  <Link
                    className={classes.socialItem}
                    href="https://x.com/BhavyaRohilla12?t=OzFi2qj_ALZyOb_d7K4aCw&s=08"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                  ...
                  <Link
                    className={classes.socialItem}
                    href="mailto:officialbhavyarohilla@gmail.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                    <MailIcon fontSize="large" className={classes.icon} />
                    <Typography>officialbhavyarohilla@gmail.com</Typography>
                  </Link>
                </Grid>
